...
batch_files = {
%     '200m200_20.mat',
%     '0916_hela-a549-br_20.mat',
%     '0916_hela-a549-mcf7-br_20.mat',
%     '0916_hela-hepg2-a549-br_20.mat',
    '0916_hela-hepg2-a549-mcf7-br_20.mat'
...
%    USIS_EM2(test_samples,cur_batch,0.65,5,edge_ada,50);
   USIS_EM2(test_samples,[cur_batch,'_auto'],0.6,10,edge_auto,80);
   
%    USIS_EM2(test_samples,[cur_batch,'_ada'],0.8,5,edge_ada,80);
   USIS_EM2(test_samples,[cur_batch,'_ada'],0.6,10,edge_ada,80);
end
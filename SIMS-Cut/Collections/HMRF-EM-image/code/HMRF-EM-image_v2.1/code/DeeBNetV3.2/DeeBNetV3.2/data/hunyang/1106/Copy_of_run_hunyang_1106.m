...
batch_files = {
% '181001_10a_20.mat',
'181106_mcf-7-high-spatial-resolution_20.mat'
...
save_pref = 'C:\Users\Yuan Zhiyuan\Documents\MATLAB\SIMS_0820\MATLAB\Add-Ons\Collections\HMRF-EM-image\code\HMRF-EM-image_v2.1\code\DeeBNetV3.2\DeeBNetV3.2\data\hunyang\1106';
   USIS_EM2(test_samples_20_processed,[cur_batch,'_ada_median'],0.6,10,edge_ada,150,save_pref);
   USIS_EM2(test_samples_20_processed,[cur_batch,'_ada_median'],0.6,15,edge_ada,150,save_pref);
   USIS_EM2(test_samples_20_processed,[cur_batch,'_ada_median'],0.6,20,edge_ada,150,save_pref);
   USIS_EM2(test_samples_20_processed,[cur_batch,'_auto_median'],0.6,10,edge_auto,150,save_pref);
   USIS_EM2(test_samples_20_processed,[cur_batch,'_auto_median'],0.6,15,edge_auto,150,save_pref);
   USIS_EM2(test_samples_20_processed,[cur_batch,'_auto_median'],0.6,20,edge_auto,150,save_pref)
   
      USIS_EM2(test_samples_20_processed,[cur_batch,'_ada_median'],0.7,10,edge_ada,150,save_pref);
   USIS_EM2(test_samples_20_processed,[cur_batch,'_ada_median'],0.7,15,edge_ada,150,save_pref);
   USIS_EM2(test_samples_20_processed,[cur_batch,'_ada_median'],0.7,20,edge_ada,150,save_pref);
   USIS_EM2(test_samples_20_processed,[cur_batch,'_auto_median'],0.7,10,edge_auto,150,save_pref);
   USIS_EM2(test_samples_20_processed,[cur_batch,'_auto_median'],0.7,15,edge_auto,150,save_pref);
   USIS_EM2(test_samples_20_processed,[cur_batch,'_auto_median'],0.7,20,edge_auto,150,save_pref);

...
save_pref = 'C:\Users\Yuan Zhiyuan\Documents\MATLAB\SIMS_0820\MATLAB\Add-Ons\Collections\HMRF-EM-image\code\HMRF-EM-image_v2.1\code\DeeBNetV3.2\DeeBNetV3.2\data\hunyang\1106';
   USIS_EM2(test_samples,[cur_batch,'_ada'],0.65,15,edge_ada,150,save_pref);
   USIS_EM2(test_samples,[cur_batch,'_ada'],0.65,10,edge_ada,150,save_pref);
   USIS_EM2(test_samples,[cur_batch,'_auto'],0.65,15,edge_auto,150,save_pref);
   USIS_EM2(test_samples,[cur_batch,'_auto'],0.65,10,edge_auto,150,save_pref);

...
%     save(['edges/edges_ori_auto_',batch_files{i}],'edge_auto');
   edge_ada11 = adaptive_constrast2(edge_auto,11,256,256);
   save(['edges/edges_ori_ada11_',batch_files{i}],'edge_ada11');
    edge_ada5 = adaptive_constrast2(edge_auto,5,256,256);
   save(['edges/edges_ori_ada5_',batch_files{i}],'edge_ada5');
   edge_ada21 = adaptive_constrast2(edge_auto,21,256,256);
   save(['edges/edges_ori_ada21_',batch_files{i}],'edge_ada21');
...
%    USIS_EM2(test_samples,[cur_batch,'_auto'],0.8,5,edge_auto,80);
   USIS_EM2(test_samples,[cur_batch,'_ada11'],0.9,15,edge_ada11,150);
   USIS_EM2(test_samples,[cur_batch,'_ada11'],0.9,20,edge_ada11,150);
%    USIS_EM2(test_samples,[cur_batch,'_ada'],0.8,5,edge_ada,80);
   USIS_EM2(test_samples,[cur_batch,'_ada5'],0.9,15,edge_ada5,150);
   USIS_EM2(test_samples,[cur_batch,'_ada5'],0.9,20,edge_ada5,150);
   
    USIS_EM2(test_samples,[cur_batch,'_ada21'],0.9,15,edge_ada21,150);
   USIS_EM2(test_samples,[cur_batch,'_ada21'],0.9,20,edge_ada21,150);

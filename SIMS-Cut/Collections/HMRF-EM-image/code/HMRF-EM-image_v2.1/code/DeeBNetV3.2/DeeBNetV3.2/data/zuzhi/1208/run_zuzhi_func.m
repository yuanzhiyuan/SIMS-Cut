...
function[]=run_zuzhi_func(process_path,test_sample_all_file,test_sample20_file,use_edges)
% save_mid_path²»ÒªÓÐ/
...
divn=10;
for beta=beta_list
    %USIS_EM2(test_samples_20,strcat(cur_batch,'_ada_test'),beta,divn,edge_ada,iters_max,save_pref);
...
save(strcat(save_final_labeling_path,'datamat.mat'),'data_mat')

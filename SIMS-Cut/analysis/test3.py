...
def run_analysis(data_mat_filename,matter_list,save_path):
   ...
   # [optimal_k_idx,final_label_list] = SIMS_cluster(train_x,cell_idx,cell_pos,k,save_path,use_representation_list,use_algorithm_list,true_y=None,figsize=(3,3),figformat='svg')
    [optimal_k_idx,final_label_list] = SIMS_cluster(train_x,cell_idx,cell_pos,k,save_path,use_algorithm_list=use_algorithm_list,true_y=None,figsize=(3,3),figformat='svg')
    #[optimal_k_idx,final_label_list] = SIMS_cluster(train_x,cell_idx,cell_pos,k,save_path,true_y=None,figsize=(3,3),figformat='svg')
    ...
    for i in range(len(final_label_list)):
        ...
        SIMS_diff(cur_label,matter_list,train_x,cell_idx,save_path,use_saved_EMD=use_saved_EMD,figsize=(3,3))
        use_saved_EMD=True
...
#data_list = ['20190103_lung2_filter','20190103_lung3_filter','20190103_lung4_filter','20190103_intestine1_filter','20190103_intestine2_filter']
#data_list = ['20190103_intestine1_filter','20190103_intestine2_filter']

#data_list = ['20190103_lung4_filter','20190103_intestine1_filter','20190103_intestine2_filter']
data_list = ['20190103_lung3_filter']

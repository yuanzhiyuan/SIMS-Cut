...
import pickle
def run_analysis(data_mat_filename,matter_list,save_path):

    mode='none'
    norm='none'
#    use_representation_list=['total_mean']
    use_algorithm_list=['SIMLR','UMAP_HDBSCAN']
    ntimes=10
   ...
   # [optimal_k_idx,final_label_list] = SIMS_cluster(train_x,cell_idx,cell_pos,k,save_path,use_representation_list,use_algorithm_list,true_y=None,figsize=(10,10),figformat='png')
    #[optimal_k_idx,final_label_list] = SIMS_cluster(train_x,cell_idx,cell_pos,k,save_path,ntimes=ntimes,use_representation_list=use_representation_list,use_algorithm_list=use_algorithm_list,true_y=None,font_scale=1.5,figsize=(10,10),figformat='png')
    [optimal_k_idx,final_label_list] = SIMS_cluster(train_x,cell_idx,cell_pos,k,save_path,ntimes=ntimes,use_algorithm_list=use_algorithm_list,true_y=None,font_scale=1.5,figsize=(10,10),figformat='png')
    ...
    for i in range(len(final_label_list)):
        ...
        SIMS_diff(cur_label,matter_list,train_x,cell_idx,save_path,use_saved_EMD=use_saved_EMD,font_scale=1.5,figformat='png')
        use_saved_EMD=True
...
#data_list = ['20190103_lung1_filter','20190103_lung2_filter','20190103_lung3_filter','20190103_lung4_filter','20190103_intestine1_filter','20190103_intestine2_filter','20190115_liverfiber1_filter','20190115_liverfiber2_filter']
#data_list = ['20190103_intestine1_filter','20190103_intestine2_filter']
#data_list = ['20190103_lung2_filter']
#data_list = ['20190115_liverfiber1_filter','20190115_liverfiber2_filter']

#data_list = ['20190103_intestine1_filter','20190103_intestine2_filter']

#data_list = ['20190117_liverfiber1_pos','20190117_liverfiber2_pos']
#data_list = ['20190115_liverfiber1_filter','20190115_liverfiber2_filter']
data_list = ['20190303_liverfiber_fix']

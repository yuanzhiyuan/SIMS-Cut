...
function[]=run_zuzhi_func_go_choose_adaauto(process_path,test_sample_all_file,test_sample20_file,use_edges,edge_type)
% save_mid_path²»ÒªÓÐ/
...
for beta=beta_list
    ...
    USIS_EM2(test_samples_20,strcat(cur_batch,'_ada_test'),beta,divn,edge_auto,iters_max,save_pref,date);
    end
